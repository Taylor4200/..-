                      ...
                      <div className="block-two">
                         <div className="bg-wrapper">
                            ...
                            <p className="fs-22 mt-20">
                               Connecting drivers and fleets with reliable, verified services 24/7 to ensure seamless operations and minimal downtime on the road.
                            </p>
                            <div className="counter-wrapper ps-xl-3 pb-30 mt-45 mb-50">
                               <div className="row">
                                  <div className="col-6">
                                     <div className="counter-block-one mt-20">
                                        <div className="main-count fw-500 color-dark">
                                           <span className="counter"><Count number={settingData?.total_interect} /></span>+
                                        </div>
                                  ...
                                  <div className="col-6">
                                     <div className="counter-block-one mt-20">
                                        <div className="main-count fw-500 color-dark">
                                           <span className="counter"><Count number={settingData?.total_visit} /></span>+
                                        </div>
