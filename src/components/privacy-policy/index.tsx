...
const PrivacyPolicy = () => {
    return (
        <div className="container mt-5">
            <h1 className="my-10 mt-150">Privacy Policy</h1>
            <p> Last updated at 2024-04-11</p>
            <section className="my-5">
                <h2>Introduction</h2>
                <p>
                    Truck Support (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy
                    explains how your personal information is collected, used, and disclosed by Truck Support.

                    This Privacy Policy applies to our website, and its associated subdomains (collectively, our
                    “Service”) alongside our application, Truck Support. By accessing or using our Service, you signify
                    that you have read, understood, and agree to our collection, storage, use, and disclosure of your
                    personal information as described in this Privacy Policy and our Terms of Service. This Privacy
                    Policy was created with Termify.
                </p>
            </section>
            <section className="my-5">
                ...
                <ul>
                    ...
                    <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Truck Support
                        LLC, 6337 wolff street that is responsible for your information under this Privacy Policy.
                    </li>
                    <li>Country: where Truck Support or the owners/founders of Truck Support are based, in this case is
                        United States
                    </li>
                    <li>Customer: refers to the company, organization or person that signs up to use the Truck Support
                    ...
                    <li>Device: any internet connected device such as a phone, tablet, computer or any other device that
                        can be used to visit Truck Support and use the services.
                    </li>
                    ...
                    <li>Personnel: refers to those individuals who are employed by Truck Support or are under contract
                    ...
                    <li>Service: refers to the service provided by Truck Support as described in the relative terms (if
                    ...
                    <li>Website: Truck Support is site, which can be accessed via this URL:
            ...
            <section className="my-5">
                ...
                <ul>
                    ...
                    <li>Billing Addresses
                    </li>
                    <li>Debit/credit card numbers
                    </li>
                    <li>Age
                    </li>
                    <li>Password
                ...
                <ul>
                    <li>Location (GPS): Location data helps to create an accurate representation of your interests, and
            ...
            <section className="my-5">
                <h2>WHEN DOES TRUCK SUPPORT USE END USER INFORMATION FROM THIRD PARTIES?</h2>
                <p>
                    Truck Support will collect End User Data necessary to provide the Truck Support services to our
                    customers.
                </p>
            ...
            <section className="my-5">
                <h2>WHEN DOES TRUCK SUPPORT USE CUSTOMER INFORMATION FROM THIRD PARTIES?</h2>
                <p>
                    We receive some information from the third parties when you contact us. For example, when you submit
                    your email address to us to show interest in becoming a Truck Support customer, we receive
                    information from a third party that provides automated fraud detection services to Truck Support. We
                    also occasionally collect information that is made publicly available on social media websites. You
            ...
            <section className="my-5">
                <h2>DO WE SHARE THE INFORMATION WE COLLECT WITH THIRD PARTIES?
                </h2>
                <p>
                ...
                <p>We may share the information that we collect, both personal and non-personal, with third parties such
                    as advertisers, contest sponsors, promotional and marketing partners, and others who provide our
                    content or whose products or services we think may interest you. We may also share it with our
                    current and future affiliated companies and business partners, and if we are involved in a merger,
                    asset sale or other business reorganization, we may also share or transfer your personal and
            ...
            <section className="my-5">
                <h2>WHERE AND WHEN IS INFORMATION COLLECTED FROM CUSTOMERS AND END USERS?
            ...
            <section className="my-5">
                <h2>HOW DO WE USE YOUR EMAIL ADDRESS?
                ...
                <p>By submitting your email address on this website, you agree to receive emails from us. You can cancel
                    ...
                    commercial emails, because we hate spam as much as you do. By submitting your email address, you
                    also agree to allow us to use your email address for customer audience targeting on sites like
                    Facebook, where we display custom advertising to specific people who have opted-in to receive
                    communications from us. Email addresses submitted only through the order processing page will be
                    used for the sole purpose of sending you information and updates pertaining to your order. If,
                    however, you have provided the same email to us through another method, we may use it for any of the
                    purposes stated in this Policy. Note: If at any time you would like to unsubscribe from receiving
                    future emails, we include detailed unsubscribe instructions at the bottom of each email.
                </p>
            </section>

            <section className="my-5">
                <h2>HOW LONG DO WE KEEP YOUR INFORMATION?

                </h2>
                <p>We keep your information only so long as we need it to provide Truck Support to you and fulfill the
                    purposes described in this policy. This is also the case for anyone that we share your information
                    with and who carries out services on our behalf. When we no longer need to use your information and
                    there is no need for us to keep it to comply with our legal or regulatory obligations, we’ll either
                    remove it from our systems or depersonalize it so that we can not identify you.
            ...
            <section className="my-5">
                ...
                <p>We implement a variety of security measures to maintain the safety of your personal information when
                    ...
                    absolute security of any information you transmit to Truck Support or guarantee that your
            ...
            <section className="my-5">
                <h2>COULD MY INFORMATION BE TRANSFERRED TO OTHER COUNTRIES?


                </h2>
                <p>Truck Support is incorporated in United States. Information collected via our website, through direct
                    interactions with you, or from use of our help services may be transferred from time to time to our
                    offices or personnel, or to third parties, located throughout the world, and may be viewed and
                    hosted anywhere in the world, including countries that may not have laws of general applicability
                    regulating the use and transfer of such data. To the fullest extent allowed by applicable law, by
                    using any of the above, you voluntarily consent to the trans-border transfer and hosting of such
                    information.
            ...
            <section className="my-5">
                <h2>IS THE INFORMATION COLLECTED THROUGH THE TRUCK SUPPORT SERVICE SECURE?
            ...
            <section className="my-5">
                <h2>CAN I UPDATE OR CORRECT MY INFORMATION?


                </h2>
                <p>CAN I UPDATE OR CORRECT MY INFORMATION?
                ...
                <p>If you are an end user and wish to update, delete, or receive any information we have about you, you
            ...
            <section className="my-5">
                ...
                <p>If you are a Truck Support worker or applicant, we collect information you voluntarily provide to us.
            ...
            <section className="my-5">
                ...
                <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other
                    transfer of all or substantially all of the assets of Truck Support or any of its Corporate
                    Affiliates (as defined herein), or that portion of Truck Support or any of its Corporate Affiliates
                    to which the Service relates, or in the event that we discontinue our business or file a petition or
                    have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that
            ...
            <section className="my-5">
                ...
                <p>The laws of United States, excluding its conflicts of law rules, shall govern this Agreement and your
                    use of the website. Your use of the website may also be subject to other local, state, national, or
                    international laws.

                </p><p>By using Truck Support or contacting us directly, you signify your acceptance of this Privacy
                Policy. If you do not agree to this Privacy Policy, you should not engage with our website, or use our
                services. Continued use of the website, direct engagement with us, or following the posting of changes
                to this Privacy Policy that do not significantly affect the use or disclosure of your personal
            ...
            <section className="my-5">
                ...
                <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites
                    not operated or controlled by Truck Support. We are not responsible for the content, accuracy or
                    opinions expressed in such websites, and such websites are not investigated, monitored or checked
                    for accuracy or completeness by us. Please remember that when you use a link to go from the Services
                    to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any
            ...
            <section className="my-5">
                ...
                <p>This website may contain third party advertisements and links to third party sites. Truck Support
                    does not make any representation as to the accuracy or suitability of any of the information
                    contained in those advertisements or sites and does not accept any responsibility or liability for
                    the conduct or content of those advertisements and sites and the offerings made by the third
                    parties.


                </p>
                <p>Advertising keeps Truck Support and many of the websites and services you use free of charge. We work
                ...
                <p>Third party advertisements and links to other sites where goods or services are advertised are not
                    endorsements or recommendations by Truck Support of the third party sites, goods or services. Truck
                    Support takes no responsibility for the content of any of the ads, promises made, or the
            ...
            <section className="my-5">
                <h2>COOKIES FOR ADVERTISING


                </h2>
                <p>These cookies collect information over time about your online activity on the website and other
            ...
            <section className="my-5">
                ...
                <p>Truck Support uses Cookies to identify the areas of our website that you have visited. A Cookie is a
                    small piece of data stored on your computer or mobile device by your web browser. We use Cookies to
                    enhance the performance and functionality of our website but are non-essential to their use.
                    However, without these cookies, certain functionality like videos may become unavailable or you
                    would be required to enter your login details every time you visit the website as we would not be
                    able to remember that you had logged in previously. Most web browsers can be set to disable the use
                    of Cookies. However, if you disable Cookies, you may not be able to access functionality on our
                    website correctly or at all. We never place Personally Identifiable Information in Cookies.
            ...
            <section className="my-5">
                ...
                <p>Wherever you are located you may also set your browser to block cookies and similar technologies, but
            ...
            <section className="my-5">
                ...
                <p>In respect to any credit card or other payment processing details you have provided us, we commit
                    that this confidential information will be stored in the most secure manner possible.
            ...
            <section className="my-5">
                ...
                <p>We collect information from kids under the age of 13 just to better our services. If You are a parent
                    or guardian and You are aware that Your child has provided Us with Personal Data without your
            ...
            <section className="my-5">
                ...
                <p>You acknowledge and agree that Truck Support shall not be responsible for any Third-Party Services,
                    including their accuracy, completeness, timeliness, validity, copyright compliance, legality,
                    decency, quality or any other aspect thereof. Truck Support does not assume and shall not have any
            ...
            <section className="my-5">
                ...
                <ul>
                    <li>Google Maps API
                        ...
                        <p>Google Maps API collects information that is held in accordance with its Privacy Policy
            ...
            <section className="my-5">
                <h2>INFORMATION ABOUT GENERAL DATA PROTECTION REGULATION (GDPR)
            ...
            <section className="my-5">
                ...
                <p>GDPR is an EU-wide privacy and data protection law that regulates how EU residents data is protected
                    by companies and enhances the control the EU residents have, over their personal data.
            ...
            <section className="my-5">
                ...
                <ul>
                    <li>Personal data collected must be processed in a fair, legal, and transparent way and should only
                        be used in a way that a person would reasonably expect.
                    </li>
                    <li>Personal data should only be collected to fulfil a specific purpose and it should only be used
            ...
            <section className="my-5">
                <h2>INDIVIDUAL DATA SUBJECTS RIGHTS - DATA ACCESS, PORTABILITY AND DELETION


                </h2>
                <p>We are committed to helping our customers meet the data subject rights requirements of GDPR. Truck
                    Support processes or stores all personal data in fully vetted, DPA compliant vendors. We do store
                    all conversation and personal data for up to 6 years unless your account is deleted. In which case,
                    we dispose of all data in accordance with our Terms of Service and Privacy Policy, but we will not
                    hold it longer than 60 days.
            ...
            <section className="my-5">
                <h2>CALIFORNIA RESIDENTS


                </h2>
                <p>The California Consumer Privacy Act (CCPA) requires us to disclose categories of Personal Information
                    we collect and how we use it, the categories of sources from whom we collect Personal Information,
                ...
                <ul>
                    ...
                    <li>Request that a business that sells a consumers personal data, not sell the consumers personal
                        data.
                    </li>
                </ul>
            ...
            <section className="my-5">
                <h2>CALIFORNIA ONLINE PRIVACY PROTECTION ACT (CALOPPA)
                ...
                <ul>
                    ...
                    <li>Right to request that a business that sells a consumers personal data, not sell the consumers
                        personal data.
                    </li>
                </ul>
                <p>If you make a request, we have one month to respond to you. If you would like to exercise any of
