...
const DashboardBody = ({data, reports}: any) => {
    ...
    const dashboard_card_data: DataType[] = [
        {
            ...
            icon: icon_1,
            title: "Impressions",
            value: data ? data?.total_visit : (reports && reports?.length > 0) ? reports[0]?.total_visit_count : 0,
        ...
        },
        {
            ...
            icon: icon_2,
            title: "Click",
            value: data ? data?.total_interect : (reports && reports?.length > 0) ? reports[0]?.total_call_count : 0,
        },
        {
            id: 3,
            icon: icon_3,
                                ...
                                <div className="recent-job-tab bg-white border-20 mt-30 plr w-100">
                                    ...
                                    <div style={{position: "absolute", bottom: 170, left: 10, right: 10}}>
                                        <p className="text-center"
                                           style={{fontWeight: "bolder", fontSize: 30}}>120,222</p>
