    ...
    return (
        <div className="dashboard-body">
            <div className="position-relative">
                ...
                {/*            <Link className="new-message-compose rounded-circle" data-bs-toggle="offcanvas"*/}
                {/*                  href="#offcanvasScrolling" role="button" aria-controls="offcanvasScrolling">+</Link>*/}
                {/*        </div>*/}
                {/*    </div>*/}
                {/*    <div className="col-lg-8">*/}
                {/*        <div*/}
                {/*            className="message-pagination ps-lg-4 ps-xxl-5 d-flex align-items-center justify-content-between md-mt-40">*/}
                {/*            <Link href="#" className="prev-msg"><Image src={icon_1} data-src="ima" alt=""*/}
                ...
                {/*            </div>*/}
                {/*            <Link href="#" className="next-msg"><Image src={icon_2} data-src="images/icon/icon_27.svg"*/}
                {/*                                                       alt="" className="lazy-img"/></Link>*/}
                {/*        </div>*/}
                {/*    </div>*/}
                {/*</div>*/}
                                    ...
                                    <div className="ps-3 pe-3 ps-xxl-4 pe-xxl-4">
                                        <div className="d-flex align-items-center justify-content-between">
                                            ...
                                            <div className="action-dots float-end">
                                                <button className="action-btn dropdown-toggle" type="button"
                                        ...
                                        <div
                                            ...
                                            <button className="filter_btn"><span
                                                style={{background: "#FF4545"}}></span> Read
                                            </button>
                                            <button className="filter_btn"><span
                                                style={{background: "#3BDA84"}}></span> Unread
                                            </button>
                                            <button className="filter_btn"><span
                                                style={{background: "#50C0FF"}}></span> Primary
                                            </button>
                                        </div>
                                    </div>
                                    <EmailReadPanel data={data} setSelectedThread={setSelectedThread}/>
                                </div>
                            </div>

                            {
                                selectedThread ? <OpenEmail selectedThread={selectedThread}/> : null
                            }
