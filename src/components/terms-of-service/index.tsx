...
const TermsService = () => {
    return (
        <div className="container mt-5">
            <h1 className="my-10 mt-150">TERMS & CONDITIONS</h1>
            <p>Last updated at 2024-04-11
            ...
            <section className="my-5">
                ...
                <p>
                    By accessing and placing an order with Truck Support, you confirm that you are in agreement with and
                    bound by the terms of service contained in the Terms & Conditions outlined below. These terms apply
                    to the entire website and any email or other type of communication between you and Truck Support.


                </p>
                <p>Under no circumstances shall Truck Support team be liable for any direct, indirect, special,
                    incidental or consequential damages, including, but not limited to, loss of data or profit, arising
                    out of the use, or the inability to use, the materials on this site, even if Truck Support team or
                    an authorized representative has been advised of the possibility of such damages. If your use of
                ...
                <p>Truck Support will not be responsible for any outcome that may occur during the course of usage of
            ...
            <section className="my-5">
                ...
                <p>
                    Truck Support grants you a revocable, non-exclusive, non-transferable, limited license to download,
            ...
            <section className="my-5">
                ...
                <ul>
                    ...
                    <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Truck Support
                        LLC, 6337 wolff street colorado arvada that is responsible for your information under this Terms
                        & Conditions.
                    </li>
            ...
            <section className="my-5">
                ...
                <ul>
                    ...
                    <li>Modify, make derivative works of, disassemble, decrypt, reverse compile or reverse engineer any
                        part of the website.
                    </li>
                    <li>Remove, alter or obscure any proprietary notice (including any notice of copyright or trademark)
                        of Truck Support or its affiliates, partners, suppliers or the licensors of the website.
                    </li>
                </ul>
            </section>
            <section className="my-5">
                ...
                <p>
                    Thanks for shopping at Truck Support. We appreciate the fact that you like to buy the stuff we
                    build. We also want to make sure you have a rewarding experience while you’re exploring, evaluating,
            ...
            <section className="my-5">
                ...
                <p>Truck Support shall be free to use, copy, modify, publish, or redistribute the Suggestions for any
            ...
            <section className="my-5">
                ...
                <p>
                    ...
                    websites not operated or controlled by Truck Support. We are not responsible for the content,
                    accuracy or opinions expressed in such websites, and such websites are not investigated, monitored
                    or checked for accuracy or completeness by us. Please remember that when you use a link to go from
                    the Services to another website, our Terms & Conditions are no longer in effect. Your browsing and
                    interaction on any other website, including those that have a link on our platform, is subject to
                    that website’s own rules and policies. Such third parties may use their own cookies or other methods
            ...
            <section className="my-5">
                <h2>CHANGES TO OUR TERMS & CONDITIONS

                </h2>
                <p>
                    You acknowledge and agree that Truck Support may stop (permanently or temporarily) providing the
                    Service (or any features within the Service) to you or to users generally at sole discretion,
                    without prior notice to you. You may stop using the Service at any time. You do not need to
                    specifically inform Truck Support when you stop using the Service. You acknowledge and agree that if
                    Truck Support disables access to your account, you may be prevented from accessing the Service, your
            ...
            <section className="my-5">
                <h2>MODIFICATIONS TO OUR WEBSITE

                </h2>
                <p>

                    Truck Support reserves the right to modify, suspend or discontinue, temporarily or permanently, the
            ...
            <section className="my-5">
                ...
                <p>Updates may modify or delete certain features and/or functionalities of the website. You agree that
                    Truck Support has no obligation to (i) provide any Updates, or (ii) continue to provide or enable
            ...
            <section className="my-5">
                ...
                <p>
                    This Agreement shall remain in effect until terminated by you or Truck Support.


                </p>
                <p>Truck Support may, in its sole discretion, at any time and for any or no reason, suspend or terminate
                    this Agreement with or without prior notice.

                </p>
                <p>This Agreement will terminate immediately, without prior notice from Truck Support, in the event that
            ...
            <section className="my-5">
                <h2>COPYRIGHT INFRINGEMENT NOTICE
                ...
                <p>If you are a copyright owner or such owner’s agent and believe any material on our website
                    ...
                    information: (a) a physical or electronic signature of the copyright owner or a person authorized to
                    act on his behalf; (b) identification of the material that is claimed to be infringing; (c) your
                    contact information, including your address, telephone number, and an email; (d) a statement by you
            ...
            <section className="my-5">
                ...
                <p>The website is provided to you "AS IS" and "AS AVAILABLE" and with all faults and defects without
                    ...
                    dealing, course of performance, usage or trade practice. Without limitation to the foregoing, Truck
                    Support provides no warranty or undertaking, and makes no representation of any kind that the
                    website will meet your requirements, achieve any intended results, be compatible or work with any
                ...
                <p>Without limiting the foregoing, neither Truck Support nor any Truck Support's provider makes any
                    ...
                    of any information or content provided through the website; or (iv) that the website, its servers,
                    the content, or e-mails sent from or on behalf of Truck Support are free of viruses, scripts, trojan
            ...
            <section className="my-5">
                ...
                <p>To the maximum extent permitted by applicable law, in no event shall Truck Support or its suppliers
                    ...
                    the website, or otherwise in connection with any provision of this Agreement), even if Truck Support
            ...
            <section className="my-5">
                ...
                <p>This Agreement, together with the Privacy Policy and any other legal notices published by Truck
                    Support on the Services, shall constitute the entire agreement between you and Truck Support
            ...
            <section className="my-5">
                ...
                <p>o failure to exercise, and no delay in exercising, on the part of either party, any right or any
            ...
            <section className="my-5">
                <h2>AMENDMENTS TO THIS AGREEMENT
            ...
            <section className="my-5">
                ...
                <p>The Agreement constitutes the entire agreement between you and Truck Support regarding your use of
            ...
            <section className="my-5">
                ...
                <p>We may change our Service and policies, and we may need to make changes to these Terms so that they
                    ...
                    (for example, through our Service) before we make changes to these Terms and give you an opportunity
                    to review them before they go into effect. Then, if you continue to use the Service, you will be
                    bound by the updated Terms. If you do not want to agree to these or any updated Terms, you can
                    delete your account.
            ...
            <section className="my-5">
                ...
                <p>The website and its entire contents, features and functionality (including but not limited to all
                    ...
                    arrangement thereof), are owned by Truck Support, its licensors or other providers of such material
                    and are protected by and international copyright, trademark, patent, trade secret and other
                    ...
                    written permission of Truck Support, unless and except as is expressly provided in these Terms &
            ...
            <section className="my-5">
                <h2>NOTICE OF DISPUTE


                </h2>
                <p>
                    In the event of a dispute, you or Truck Support must give the other a Notice of Dispute, which is a
                    written statement that sets forth the name, address, and contact information of the party giving it,
                    the facts giving rise to the dispute, and the relief requested. You must send any Notice of Dispute
                    via email to: [email protected]. Truck Support will send any Notice of Dispute to you by mail to
                    your address if we have it, or otherwise to your email address. You and Truck Support will attempt
                    to resolve any dispute through informal negotiation within sixty (60) days from the date the Notice
                    of Dispute is sent. After sixty (60) days, you or Truck Support may commence arbitration.
            ...
            <section className="my-5">
                <h2>BINDING ARBITRATION


                </h2>
                <p>If you and Truck Support don’t resolve any dispute by informal negotiation, any other effort to
                    resolve the dispute will be conducted exclusively by binding arbitration as described in this
                    section. You are giving up the right to litigate (or participate in as a party or class member) all
                    disputes in court before a judge or jury. The dispute shall be settled by binding arbitration in
                    accordance with the commercial arbitration rules of the American Arbitration Association. Either
                    ...
                    arbitration. Any and all legal, accounting, and other costs, fees, and expenses incurred by the
            ...
            <section className="my-5">
                ...
                <p>
                    ...
                    of Truck Support without any compensation or credit to you whatsoever. Truck Support and its
                    affiliates shall have no obligations with respect to such submissions or posts and may use the ideas
                    contained in such submissions or posts for any purposes in any medium in perpetuity, including, but
            ...
            <section className="my-5">
                ...
                <p>Additional terms and conditions may apply to purchases of goods or services on or through the Services, which terms and conditions are made a part of this Agreement by this reference.

                </p>
            </section>

            <section className="my-5">
                <h2>TYPOGRAPHICAL ERRORS
            ...
            <section className="my-5">
                ...
                <p>
                    If for any reason a court of competent jurisdiction finds any provision or portion of these Terms & Conditions to be unenforceable, the remainder of these Terms & Conditions will continue in full force and effect. Any waiver of any provision of these Terms & Conditions will be effective only if in writing and signed by an authorized representative of Truck Support. Truck Support will be entitled to injunctive or other equitable relief (without the obligations of posting any bond or surety) in the event of any breach or anticipatory breach by you. Truck Support operates and controls the Truck Support Service from its offices in . The Service is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation. Accordingly, those persons who choose to access the Truck Support Service from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable. These Terms & Conditions (which include and incorporate the Truck Support Privacy Policy) contains the entire understanding, and supersedes all prior understandings, between you and Truck Support concerning its subject matter, and cannot be changed or modified by you. The section headings used in this Agreement are for convenience only and will not be given any legal import.
            ...
            <section className="my-5">
                ...
                <p>Truck Support is not responsible for any content, code or any other imprecision.


                </p>
                <p>Truck Support does not provide warranties or guarantees.
